...
def get_sogou_index_dict(keyword):
		...
		sogou_index_dict["total_search_index"] = source_dict["avgPv"]
		...
		sogou_index_dict["mobile_search_index"] = source_dict["avgWapPv"]
...
def run_main():
    keyword = "arduino"
		sogou_index_dict = get_sogou_index_dict(keyword)
